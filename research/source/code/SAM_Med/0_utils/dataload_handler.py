...
class DataLoaderHandler():
    ...
    def load_split_from_json(self):
        ...
        self.training_image_ids = set(data["training_image_ids"])
        self.validation_image_ids = set(data["validation_image_ids"])
    ...
    def setup_dataloaders(self):
        self.setup_specific_dataloader('training')
        self.setup_specific_dataloader('validation')      

    def setup_specific_dataloader(self, mode : str):
        assert mode in ['validation', 'training'], 'Mode must be either validation or training'

        if mode == 'validation' and self.validation_dataset is None:
        ...
        elif mode == 'training' and self.training_dataset is None:
